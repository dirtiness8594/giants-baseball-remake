...
function Highlight() {
    ...
    const highlightData = {
        ...
        description: "A muito tempo dedicamos nossa paixão pelo Beisebol. Fundados em 1998. Contando hoje com tantos membros, somos.",
    ...
    return (
        <section className="highlight" id="about">
            ...
            <div className="highlight__info">
                ...
                <button className="localization__button">{highlightData.buttonLabel}</button>
            </div>
